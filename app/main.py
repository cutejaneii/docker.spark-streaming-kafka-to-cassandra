...
def CreateSparkContext():
    ...
    sparkConf = SparkConf()                                                       \
                         ...
                         .set("spark.cassandra.connection.host", "192.168.1.1")
...
def HandleError(rowRdd):
    try:
        ...
        if lstRowRdd > 0:
            producer = KafkaProducer(bootstrap_servers='192.168.1.1:9092')
...
def main():
    ...
    try:
        kafka_stream = KafkaUtils.createStream(ssc, "192.168.1.1:2181", "spark-streaming-consumer", {topic:12})
